...
__export(index_exports, {
  ...
  arrayCodecs: () => arrayCodecs,
  binaryArrayCodec: () => binaryArrayCodec,
  binaryCodec: () => binaryCodec,
  boolArrayCodec: () => boolArrayCodec,
  boolCodec: () => boolCodec,
  enumArrayCodec: () => uintArrayCodec,
  enumCodec: () => uintCodec,
  floatArrayCodec: () => floatArrayCodec,
  floatCodec: () => floatCodec,
  hash: () => hash,
  int64ArrayCodec: () => int64ArrayCodec,
  int64Codec: () => int64Codec,
  intArrayCodec: () => intArrayCodec,
  intCodec: () => intCodec,
  scalarCodecs: () => scalarCodecs,
  string16ArrayCodec: () => string16ArrayCodec,
  string16Codec: () => string16Codec,
  string32ArrayCodec: () => string32ArrayCodec,
  string32Codec: () => string32Codec,
  string64ArrayCodec: () => string64ArrayCodec,
  string64Codec: () => string64Codec,
  uint64ArrayCodec: () => uint64ArrayCodec,
  uint64Codec: () => uint64Codec,
  uintArrayCodec: () => uintArrayCodec,
  uintCodec: () => uintCodec,
  vector2ArrayCodec: () => vector2ArrayCodec,
  vector2Codec: () => vector2Codec,
  vector3ArrayCodec: () => vector3ArrayCodec,
  vector3Codec: () => vector3Codec,
  wString16ArrayCodec: () => wString16ArrayCodec,
  wString16Codec: () => wString16Codec,
  wString32ArrayCodec: () => wString32ArrayCodec,
  wString32Codec: () => wString32Codec,
  wString64ArrayCodec: () => wString64ArrayCodec,
  wString64Codec: () => wString64Codec
});
module.exports = __toCommonJS(index_exports);

// src/Types.ts
var StructType = /* @__PURE__ */ ((StructType3) => {
  StructType3[StructType3["Bool"] = 0] = "Bool";
  StructType3[StructType3["BoolArray"] = 1] = "BoolArray";
  StructType3[StructType3["Int"] = 2] = "Int";
  StructType3[StructType3["IntArray"] = 3] = "IntArray";
  StructType3[StructType3["Float"] = 4] = "Float";
  StructType3[StructType3["FloatArray"] = 5] = "FloatArray";
  StructType3[StructType3["Enum"] = 6] = "Enum";
  StructType3[StructType3["EnumArray"] = 7] = "EnumArray";
  StructType3[StructType3["Vector2"] = 8] = "Vector2";
  StructType3[StructType3["Vector2Array"] = 9] = "Vector2Array";
  StructType3[StructType3["Vector3"] = 10] = "Vector3";
  StructType3[StructType3["Vector3Array"] = 11] = "Vector3Array";
  StructType3[StructType3["String16"] = 12] = "String16";
  StructType3[StructType3["String16Array"] = 13] = "String16Array";
  StructType3[StructType3["String32"] = 14] = "String32";
  StructType3[StructType3["String32Array"] = 15] = "String32Array";
  StructType3[StructType3["String64"] = 16] = "String64";
  StructType3[StructType3["String64Array"] = 17] = "String64Array";
  StructType3[StructType3["Binary"] = 18] = "Binary";
  StructType3[StructType3["BinaryArray"] = 19] = "BinaryArray";
  StructType3[StructType3["UInt"] = 20] = "UInt";
  StructType3[StructType3["UIntArray"] = 21] = "UIntArray";
  StructType3[StructType3["Int64"] = 22] = "Int64";
  StructType3[StructType3["Int64Array"] = 23] = "Int64Array";
  StructType3[StructType3["UInt64"] = 24] = "UInt64";
  StructType3[StructType3["UInt64Array"] = 25] = "UInt64Array";
  StructType3[StructType3["WString16"] = 26] = "WString16";
  StructType3[StructType3["WString16Array"] = 27] = "WString16Array";
  StructType3[StructType3["WString32"] = 28] = "WString32";
  StructType3[StructType3["WString32Array"] = 29] = "WString32Array";
  StructType3[StructType3["WString64"] = 30] = "WString64";
  StructType3[StructType3["WString64Array"] = 31] = "WString64Array";
  StructType3[StructType3["Bool64bitKey"] = 32] = "Bool64bitKey";
  return StructType3;
})(StructType || {});
...
var StructEntry = class {
  ...
  hash = 0;
  offset = 0;
  constructor(view, type, hash2, offset) {
    this.#view = view;
...
var GameData = class _GameData extends BaseGameData {
  ...
  static fromArrayBuffer(buffer) {
    ...
    if (gameData.#dataView.byteLength < 32) {
      throw new ParseError("Invalid file. Too Small.");
    }
    if (gameData.#dataView.getUint32(0, true) !== 16909060) {
      throw new Error("Invalid File. Magic Mismatch.");
    }
    const dataOffset = gameData.#dataView.getUint32(8, true);
    if (dataOffset < 32 || dataOffset > gameData.#dataView.byteLength) {
